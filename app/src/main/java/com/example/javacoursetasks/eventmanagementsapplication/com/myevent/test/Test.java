package com.example.javacoursetasks.eventmanagementsapplication.com.myevent.test;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		Organizer organizer2 = new Organizer ("Zewail University");
		// you can create another object of the same class
		System.out.println("Organizer(s): " + organizer2.name);
		System.out.println("\n");

		Event event2 = new Event("Sceince Inventions", "An event held by Ahmed Zewail University to" + "\n"
		+"inspire the youth to emabark on new sceince journeys.", "October 22nd at 10 AM", "October 24th at 7 PM", false);
		System.out.println("Event: " + event2.name);
		System.out.println("Description: " + event2.description);
		System.out.println("Start Time: " + event2.startTime);
		System.out.println("End Time: " + event2.endTime);
		System.out.println("Started: " + event2.isStarted);
		System.out.println("\n");
		...
		Venue venue2 = new Venue("Ahmed Zewail University in Sheikh Zaid", "Egypt", "Cairo",
				" 26VM+V8R, Ismailia, Qasr El Nil, Cairo Governorate 4272081");
		System.out.println("Venue: " + venue2.name);
		System.out.println("Country: " + venue2.country);
		System.out.println("City: " + venue2.city);
		System.out.println("Address: " + venue2.streetAdress);
		System.out.println("\n");
